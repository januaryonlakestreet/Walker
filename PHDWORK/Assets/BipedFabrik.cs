...
using UnityEngine;
using System.Linq;
public class BipedFabrik : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!AtDestination() && LegsClearToMove())
        {
            ...
            {
                case 0:
                    StepGoalObject = BipedLeftLegGoal.Target.GetComponent<GoalBiped>();

                    break;
                case 1:
                    StepGoalObject = BipedRightLegGoal.Target.GetComponent<GoalBiped>();
